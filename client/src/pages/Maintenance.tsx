      ...
      <Card className="max-w-md w-full text-center">
        ...
        <CardContent className="pt-6 space-y-6">
          ...
          <div className="bg-primary/5 p-8 rounded-lg border border-primary/10">
            <p className="text-sm font-medium text-primary">Season 3 Kickoff Countdown</p>
            <p className="text-[10px] text-muted-foreground/60 mt-2 uppercase tracking-widest">Prepare for Glory</p>
          </div>
